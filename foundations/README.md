...
**Example Response**
    ...
    Body:
    {
        "versions": [{
            "api_id": "foundations",
            "version_id": "1.0",
            "detailed_version": "https://github.com/BuildingSMART/foundations-api"
        }, {
            "api_id": "bcf",
            "version_id": "2.1",
...
OAuth2 flows are described in detail in the [OAuth2 specification](https://tools.ietf.org/html/rfc6749). Open CDE API servers may support the following workflows:
